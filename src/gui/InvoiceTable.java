...
public class InvoiceTable extends JPanel {
	...
	private void configureColumnWidths() {
		...
		table.getColumnModel().getColumn(InvoiceTableModel.INVOICE_DATE_COLUMN).setMaxWidth(100);
		table.getColumnModel().getColumn(InvoiceTableModel.INVOICE_DATE_COLUMN).setPreferredWidth(100);
		table.getColumnModel().getColumn(InvoiceTableModel.START_DATE_COLUMN).setMaxWidth(100);
		table.getColumnModel().getColumn(InvoiceTableModel.START_DATE_COLUMN).setPreferredWidth(100);
		table.getColumnModel().getColumn(InvoiceTableModel.END_DATE_COLUMN).setMaxWidth(100);
		table.getColumnModel().getColumn(InvoiceTableModel.END_DATE_COLUMN).setPreferredWidth(100);
		...
		table.getColumnModel().getColumn(InvoiceTableModel.PAYMENT_METHOD_COLUMN).setMaxWidth(160);
		...
		table.getColumnModel().getColumn(InvoiceTableModel.INVOICE_NUMBER_COLUMN).setMaxWidth(250);
		table.getColumnModel().getColumn(InvoiceTableModel.INVOICE_NUMBER_COLUMN).setPreferredWidth(200);
