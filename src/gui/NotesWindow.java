...
public class NotesWindow {
	...
	private static final String[] notes = { "\n"
			...
			"\n   YOU ARE A SUB FOR A CLASS:\n        There are two ways to select a class that you want to view:\n"
					...
					+ "        If more detail is needed, double-click on one of the students under the attendance\n"
					+ "        column to get more of a history.\n\n"
					+ "   YOU ARE DOING A MAKE-UP SESSION:\n"
					+ "        Go to the Attendance menu and find the student. Select, then right-click on the\n"
					+ "        class in the Attendance column to view what their class has been doing.\n\n"
			...
			"\n                                         This is a work in progress, and we're in Phase I.\n"
					...
					+ "         The next phase is to port the GUI to a web app. If you're interested in helping, let us know!\n\n"
